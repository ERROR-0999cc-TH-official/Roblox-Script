...
setclipboard("Discord Server : https://discord.gg/kShJy84u2v
TikTok : @error_0999cc_th_official") -- คัดลอก
...
-- ===================================================  
local getScript3 = createToggle(wsjpPage, "[ ◆ ] Simple Shader", cheatStartY + 80, function()
...
-- ===================================================  
local getScript4 = createToggle(wsjpPage, "[ ◆ ]  Pshade Ultimate Shader", cheatStartY + 120, function()
