...
local function ERCloading()
	for _, gui in ipairs(getUIParent():GetDescendants()) do
		if gui:IsA("ScreenGui") and gui.Name == "ERC.GUI.ScreenGui.Main" then
			return true
		end
	end
	return false
...
if not ERCloading() then
-- ===================================================
-- ฟังก์ชันสร้าง UICorner สำหรับมุมโค้ง
local function createUICorner(parent, radius)
    local corner = Instance.new("UICorner")
    corner.CornerRadius = radius or UDim.new(0, 6) -- default 10
    corner.Parent = parent
    return corner
end

-- ฟังก์ชันสร้าง UIStroke สำหรับเส้นขอบ
local function createUIStroke(parent, thickness, color)
    local stroke = Instance.new("UIStroke")
    stroke.Thickness = thickness or 1.5 -- ค่าเริ่มต้น
...
local function DraggingGUI(frame)
...
screenGuiUS.DisplayOrder = 2147483640
...
createUICorner(progressBg, UDim.new(0, 8))
...
createUICorner(progressBar, UDim.new(0, 8))
...
◇==============================================◇
❖ ERC GUI          | by ERC-Technology™ | @erc.technology.tm.th
❖ Contact channels | Discord Server : https://discord.gg/kShJy84u2v | [ ERC-Technology™ Discord Server ]
❖ Version          | V.0.5.3
...
setclipboard("Discord Server : https://discord.gg/kShJy84u2v | [ ERC-Technology™ Discord Server ]") -- คัดลอก
...
DraggingGUI(MainFrame) -- เรียกใช้งาน Drag function
...
MaintitleLabel.Text = "[ ❖ ] ERC GUI V.0.5.3 | Product of Thailand | PC & Mobile"
...
DraggingGUI(MainiconButton) -- เรียกใช้งาน Drag function
...
ScreenGuiAll.DisplayOrder = 2147483600
...
local function createToggleText(parent, name, PlaceholderText, yPos)
    local container = Instance.new("Frame")
    container.Size = UDim2.new(1, -50, 0, 35)
    container.Position = UDim2.new(0, 25, 0, yPos)
    container.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
    ...
    inputBoxFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
    inputBoxFrame.ZIndex = 20001
    inputBoxFrame.Parent = container
    createUICorner(inputBoxFrame)
    createUIStroke(inputBoxFrame, 2, Color3.fromRGB(45,45,45))
...
local function createToggleColorPicke(parent, name, yPos, defaultColor)
...
contentFramePlayer.CanvasSize = UDim2.new(0, 0, 0, 300)
...
-- สร้าง Toggle
local getInfiniteJump = createToggle(PlayerPage, "Infinite Jump", cheatStartY + 89)

local getFly = createToggle(PlayerPage, "FLY (GUI)", cheatStartY + 132)

local getNoClip = createToggle(PlayerPage, "NoClip", cheatStartY + 175)

local getShiftLock = createToggle(PlayerPage, "Shift Lock", cheatStartY + 218)
...
-- สร้าง Toggle
local getRemovefog = createToggle(VisualPage, "Remove fog", cheatStartY + 89)

local getGrayscaleMode = createToggle(VisualPage, "Grayscale Mode", cheatStartY + 132)

local getESPPlayer = createToggle(VisualPage, "ESP Player", cheatStartY + 175)

local getXray = createToggle(VisualPage, "X-ray", cheatStartY + 218)

local getFPS = createToggle(VisualPage, "FPS (GUI)", cheatStartY + 261)

local getInfiniteZoom = createToggle(VisualPage, "Infinite Zoom", cheatStartY + 304)

local getblackscreen = createToggle(VisualPage, "Black screen", cheatStartY + 347)

local getWhitescreen = createToggle(VisualPage, "white screen", cheatStartY + 390)
...
FrameFPS.ZIndex = 500
createUICorner(FrameFPS, UDim.new(0, 8)) 
...
createUICorner(iconTextFPS, UDim.new(0, 8))
...
ScreenGuiBW.DisplayOrder = 2147483000
...
-- ===================================================  
local getScript1 = createToggleButton(FunctionPage, "[ ❖ ] Disconnection", "Button", cheatStartY + 3, function()
...
-- ===================================================  
local getScript2 = createToggleButton(FunctionPage, "[ ❖ ] Roblox Developer Console", "Button", cheatStartY + 46, function()

Notification("[ ❖ ] ERC SYSTEM", "Roblox Developer Console Loading!", "rbxassetid://12348119032", 2)
...
-- ===================================================  
local getScript3 = createToggleButton(FunctionPage, "[ ❖ ] Infinite Yield FE", "Button", cheatStartY + 89, function()
    
Notification("[ ❖ ] ERC SYSTEM", "Script Infinite Yield FE Loading!", "rbxassetid://12348119032", 2)
...
-- ===================================================  
local getScript4 = createToggleButton(FunctionPage, "Script 4", "Button", cheatStartY + 132, function()
...
-- ===================================================  
local getScript5 = createToggleButton(FunctionPage, "Script 5", "Button", cheatStartY + 175, function()
...
-- ===================================================  
local getScript6 = createToggleButton(FunctionPage, "Script 6", "Button", cheatStartY + 218, function()
...
-- ===================================================  
local getScript7 = createToggleButton(FunctionPage, "[ ⚠ ] System Testing", "Button", cheatStartY + 261, function()
    
    local start = tick()
    while tick()-start<2 do for i=1,1e2 do local a=math.random() end end
    
end)

-- ===================================================  
local getScript8 = createToggleButton(FunctionPage, "[ ◆ ] Emotes Animation", "Button", cheatStartY + 304, function()
    
Notification("[ ❖ ] ERC SYSTEM", "Script Emotes Animation Loading!", "rbxassetid://12348119032", 2)
...
-- ===================================================  
local getScript9 = createToggleButton(FunctionPage, "[ ◆ ] Simple Shader", "Button", cheatStartY + 347, function()
    
Notification("[ ❖ ] ERC SYSTEM", "Script Simple Shader Loading!", "rbxassetid://12348119032", 2)
...
-- ===================================================  
local getScript10 = createToggleButton(FunctionPage, "[ ◆ ]  Pshade Ultimate Shader", "Button", cheatStartY + 390, function()
    
Notification("[ ❖ ] ERC SYSTEM", "Script Pshade Ultimate Shader Loading!", "rbxassetid://12348119032", 2)
...
local teleportInput = createToggleText(TeleportPage, "Teleport to Player", "Player Name...", cheatStartY + 3)

local getTPPlayerLooped = createToggle(TeleportPage, "Teleport", cheatStartY + 46)
...
contentFrameGames.CanvasSize = UDim2.new(0, 0, 0, 438)
...
contentFrameMusic.CanvasSize = UDim2.new(0, 0, 0, 133)
...
idBox.Text = "97413868131214"
idBox.ZIndex = 20000
idBox.Parent = musicPage
idBox.TextWrapped = true
createUICorner(idBox) 
...
volDisplay.TextWrapped = true
volDisplay.ZIndex = 20000
volDisplay.Parent = musicPage
createUICorner(volDisplay) 
...
createUICorner(repeatLight, UDim.new(0, 8))
...
volDownBtn.MouseButton1Click:Connect(function()
    sound.Volume = math.clamp(sound.Volume - 0.1, 0, 10)
...
for i, name in ipairs(menuItems) do
    ...
    createUICorner(buttonFrame, UDim.new(0, 6))
