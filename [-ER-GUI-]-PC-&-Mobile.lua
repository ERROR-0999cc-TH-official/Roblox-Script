...
local getESPPlayer = createToggle(VisualPage, "ESP Player", cheatStartY + 261)

local getXray = createToggle(VisualPage, "X-ray", cheatStartY + 304)

local getFPS = createToggle(VisualPage, "FPS (GUI)", cheatStartY + 347)

local getInfiniteZoom = createToggle(VisualPage, "Infinite Zoom", cheatStartY + 390)

local getblackscreen = createToggle(VisualPage, "Black screen", cheatStartY + 433)

local getWhitescreen = createToggle(VisualPage, "white screen", cheatStartY + 476)
...
-- ===================================================  
local getScript1 = createToggle(FunctionPage, "[ ❖ ] Disconnection", cheatStartY + 3, function()
...
-- ===================================================  
local getScript2 = createToggle(FunctionPage, "[ ❖ ] Roblox Developer Console", cheatStartY + 46, function()
...
-- ===================================================  
local getScript3 = createToggle(FunctionPage, "[ ❖ ] Infinite Yield FE", cheatStartY + 89, function()
...
-- ===================================================  
local getScript4 = createToggle(FunctionPage, "Script 4", cheatStartY + 132, function()
...
-- ===================================================  
local getScript5 = createToggle(FunctionPage, "Script 5", cheatStartY + 175, function()
...
-- ===================================================  
local getScript6 = createToggle(FunctionPage, "Script 6", cheatStartY + 218, function()
...
-- ===================================================  
local getScript7 = createToggle(FunctionPage, "[ ⚠ ] System Testing", cheatStartY + 261, function()
...
-- ===================================================  
local getScript8 = createToggle(FunctionPage, "[ ◆ ] Emotes Animation", cheatStartY + 304, function()
...
-- ===================================================  
local getScript9 = createToggle(FunctionPage, "[ ◆ ] Simple Shader", cheatStartY + 347, function()
...
-- ===================================================  
local getScript10 = createToggle(FunctionPage, "[ ◆ ]  Pshade Ultimate Shader", cheatStartY + 390, function()
