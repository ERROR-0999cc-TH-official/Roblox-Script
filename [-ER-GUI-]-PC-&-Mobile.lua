...
❖ Contact channels | Discord Server : https://discord.gg/kShJy84u2v | ERC-Technology™
❖ Version          | V.0.5.0
...
setclipboard("Discord Server : https://discord.gg/kShJy84u2v | ERC-Technology™") -- คัดลอก
...
titleLabel.Text = "ER GUI | V.0.5.0 | By ERC-Technology™ (ERC)"
...
iconButton.Parent = ScreenERGui
iconButton.Active = true
createUICorner(iconButton) 

-- ===================================================
-- Center iconButton
local function centerIconButton()
local viewportSize = camera and camera.ViewportSize or Vector2.new(1280, 720)
...
enableDragA(iconButton) -- เรียกใช้งาน Drag function
...
local function createToggle(parent, name, yPos)
    ...
    createUICorner(statusLight, UDim.new(0, 8))
...
elseif syn and syn.protect_gui then
	...
	main.Parent = CoreGui
elseif CoreGui:FindFirstChild("RobloxGui") then
	main.Parent = CoreGui:FindFirstChild("RobloxGui")
else
	main.Parent = CoreGui
end
...
-- ===================================================
-- Drag function
local function enableDragB(frame)
    local dragging = false
    local dragInput, dragStart, startPos
...
--[[
• ตัวอย่างการใช้งาน
enableDragB(ใส่ชื่อ object ที่ต้องการ)
• แบบนี้
enableDragB(mainFrame)
]]

enableDragB(Frame) -- เรียกใช้งาน Drag function
