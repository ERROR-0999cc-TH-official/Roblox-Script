...
-- ===================================================  
local getScript1 = createToggleButton(FunctionPage, "[ ❖ ] Disconnection", cheatStartY + 3, function()
...
-- ===================================================  
local getScript2 = createToggleButton(FunctionPage, "[ ❖ ] Roblox Developer Console", cheatStartY + 46, function()
...
-- ===================================================  
local getScript3 = createToggleButton(FunctionPage, "[ ❖ ] Infinite Yield FE", cheatStartY + 89, function()
...
-- ===================================================  
local getScript4 = createToggleButton(FunctionPage, "Script 4", cheatStartY + 132, function()
...
-- ===================================================  
local getScript5 = createToggleButton(FunctionPage, "Script 5", cheatStartY + 175, function()
...
-- ===================================================  
local getScript6 = createToggleButton(FunctionPage, "Script 6", cheatStartY + 218, function()
...
-- ===================================================  
local getScript7 = createToggleButton(FunctionPage, "[ ⚠ ] System Testing", cheatStartY + 261, function()
...
-- ===================================================  
local getScript8 = createToggleButton(FunctionPage, "[ ◆ ] Emotes Animation", cheatStartY + 304, function()
...
-- ===================================================  
local getScript9 = createToggleButton(FunctionPage, "[ ◆ ] Simple Shader", cheatStartY + 347, function()
...
-- ===================================================  
local getScript10 = createToggleButton(FunctionPage, "[ ◆ ]  Pshade Ultimate Shader", cheatStartY + 390, function()
