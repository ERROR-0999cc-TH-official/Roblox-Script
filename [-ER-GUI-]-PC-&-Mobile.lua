...
contentFrame.CanvasSize = UDim2.new(0, 0, 0, 400) -- ตั้งค่าเอง (ตัวอย่าง ###px)
...
local transparencyLevel = 0.8 -- ระดับความโปร่งใส (0 = ทึบ, 1 = หายหมด)
...
screenGuiBW.DisplayOrder = 2000000
